      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-12 space-y-16">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} className="space-y-4">
            ...
            <motion.p variants={reveal} className="text-gray-300 max-w-md text-sm">
              Empowering generations - integrating <span className="text-[#f37121] font-semibold">childcare</span>, <span className="text-[#f37121] font-semibold">international education</span>, <span className="text-[#f37121] font-semibold">heavy transport & logistics</span>, and <span className="text-[#f37121] font-semibold">real estate development</span>. Trusted, compliant, and built for Vision 2030 impact.
            </motion.p>
            ...
            <motion.div variants={reveal} className="flex flex-wrap gap-2 mt-4 text-xs text-gray-400">
              <div className="bg-white/5 px-3 py-1.5 rounded-lg flex items-center gap-1"><FaMapMarkerAlt className="text-[#f37121] text-xs" /> Headquartered: Jeddah</div>
              <div className="bg-white/5 px-3 py-1.5 rounded-lg flex items-center gap-1"><FaTruckMoving className="text-[#f37121] text-xs" /> Fleet: 34 trucks</div>
              <div className="bg-white/5 px-3 py-1.5 rounded-lg flex items-center gap-1"><FaBuilding className="text-[#f37121] text-xs" /> Projects: 15+ completed</div>
            </motion.div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="flex justify-center">
            <div className="relative w-full max-w-sm rounded-xl overflow-hidden border border-white/10 shadow-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                <h3 className="text-lg font-bold">Building Futures Since 2024</h3>
                <p className="text-gray-300 text-xs mt-1">Committed to excellence in education, childcare, logistics, and real estate</p>
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {[
            ...
            { label: 'Trucks', value: counters.trucks, icon: <FaTruckMoving />, suffix: '+' },
            { label: 'Employees', value: counters.employees, icon: <FaUsers />, suffix: '+' },
            { label: 'Projects', value: counters.projects, icon: <FaBuilding />, suffix: '+' },
          ].map((s, i) => (
            <motion.div 
              key={i} 
              initial={{ opacity: 0, y: 16 }} 
        ...
        <section className="space-y-6">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-[#f37121]">Our Business Divisions</h2>
            <p className="text-gray-400 mt-1 text-sm max-w-xl mx-auto">Four integrated pillars working together to build a better future for Saudi families and businesses</p>
          </div>
...
{/* card 4 - REAL ESTATE */}
            ...
            >
              <div className="flex flex-col gap-3 items-start">
                <div className="w-full h-30 rounded-lg overflow-hidden border border-white/10 shadow">
                  <img src="/images/ew.jpeg" alt="real estate" className="w-full h-full object-cover" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-[#f37121]">Real Estate & Construction</h3>
                  <p className="text-gray-300 text-xs mt-1">Premium residential and commercial developments with quality craftsmanship, timely delivery, and innovative design.</p>
                  <div className="flex flex-wrap gap-1 mt-3 text-xs">
                    <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full">Development</span>
                    <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full">Construction</span>
                  </div>
                </div>
              </div>
              <Link 
            ...
            >
              <div className="flex flex-col gap-3 items-start">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#f37121]">Heavy Truck & Logistics</h3>
                  <p className="text-gray-300 text-xs mt-1">Project-based heavy haulage for construction, energy and manufacturing with telematics and predictive maintenance.</p>
                  <div className="flex flex-wrap gap-1 mt-3 text-xs">
                    <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full">Telematics</span>
                    <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full">24/7 Support</span>
        ...
        <section className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-300 text-sm">Shape a future where families thrive through accessible education, quality childcare, dependable logistics, and premium real estate solutions that support national growth.</p>
            <div className="mt-4 p-3 bg-white/5 rounded-lg">
              <p className="text-xs text-gray-400">Aligned with Vision 2030 - workforce participation & private sector growth.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 text-sm">Deliver meaningful services that enrich lives, inspire growth, and build trust through innovation, safety, operational excellence, and quality construction.</p>
            <div className="mt-4 p-3 bg-white/5 rounded-lg">
              <p className="text-xs text-gray-400">People-first: families, employees, and communities.</p>
            </div>
          </motion.div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid md:grid-cols-5 gap-3 text-sm">
            ...
            >
              ...
              <div className="text-gray-400 text-xs mt-1">Launch real estate division</div>
              <div className="mt-2 h-1 w-10 bg-[#f37121] rounded-full mx-auto"></div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 16 }}
            ...
            >
              <div className="text-base font-bold text-[#f37121]">Q3 2026</div>
              <div className="text-gray-400 text-xs mt-1">Open EFG International Schools</div>
              <div className="mt-2 h-1 w-10 bg-[#f37121] rounded-full mx-auto"></div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-6 items-start">
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-lg font-bold text-[#f37121]">Real Estate & Construction Division</h4>
            </div>
            <p className="text-gray-300 text-sm mb-4">EFG Properties delivers premium residential and commercial developments with uncompromising quality and innovative design.</p>
            
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-white/5 p-3 rounded-lg">
                <div className="text-base font-bold text-[#f37121]">Residential</div>
                <p className="text-gray-400 text-xs mt-1">Luxury apartments & villas</p>
              </div>
              <div className="bg-white/5 p-3 rounded-lg">
                <div className="text-base font-bold text-[#f37121]">Commercial</div>
                <p className="text-gray-400 text-xs mt-1">Office & retail spaces</p>
              </div>
              <div className="bg-white/5 p-3 rounded-lg">
                <div className="text-base font-bold text-[#f37121]">Construction</div>
                <p className="text-gray-400 text-xs mt-1">Turnkey projects</p>
              </div>
              <div className="bg-white/5 p-3 rounded-lg">
                <div className="text-base font-bold text-[#f37121]">Consultancy</div>
                <p className="text-gray-400 text-xs mt-1">Project management</p>
              </div>
            </div>

            <div className="flex flex-wrap gap-2">
              <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full text-xs">Quality Craftsmanship</span>
              <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full text-xs">Timely Delivery</span>
              <span className="bg-[#f37121]/20 text-[#f37121] px-2 py-1 rounded-full text-xs">Innovative Design</span>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full h-68 rounded-lg overflow-hidden">
              <img src="/images/ew.jpeg" alt="real estate projects" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-3">
                <div className="text-white">
                  <h5 className="font-bold text-sm">Premium Developments</h5>
                  <p className="text-xs text-gray-300">Building tomorrows landmarks today</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <section className="grid md:grid-cols-3 gap-6 items-start">
          <div className="md:col-span-2 bg-white/8 backdrop-blur p-4 rounded-xl border border-white/10 shadow-lg">
            ...
            <p className="text-gray-300 text-sm">EFG drives eco-efficiency across all divisions - green building standards, fuel-efficient logistics, community scholarships, and workplace childcare initiatives.</p>
            <div className="grid grid-cols-3 gap-3 mt-4">
              <div className="bg-white/5 p-3 rounded-lg text-center">
                <div className="text-base font-bold text-[#f37121]">Green Building</div>
                <p className="text-gray-400 text-xs mt-1">Sustainable construction</p>
              </div>
              <div className="bg-white/5 p-3 rounded-lg text-center">
                <div className="text-base font-bold text-[#f37121]">Fuel-efficiency</div>
                <p className="text-gray-400 text-xs mt-1">Reducing emissions</p>
        ...
        <section>
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-[#f37121]">Our Leadership Team</h2>
            <p className="text-gray-400 mt-1 text-sm max-w-xl mx-auto">Experienced professionals driving our vision forward across all divisions</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: 'Ahmed Hassan', title: 'COO', img: '/images/107.jpeg', desc: '8+ years in Management' },
              { name: 'Hossam Magdy', title: 'CEO', img: '/images/101.jpeg', desc: '15+ years in business development' },
              { name: 'Eslam Zaky', title: 'B2C HOD', img: '/images/102.jpeg', desc: 'Logistics expert with 10+ years' },
              { name: 'Mohamed Ramy', title: 'HR Manager', img: '/images/103.jpeg', desc: 'Talent development specialist' },
            ].map((p, i) => (
              <motion.div 
                key={i} 
                initial={{ opacity: 0, y: 16 }}
        ...
        <section>
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-[#f37121]">Our Gallery</h2>
            <p className="text-gray-400 mt-1 text-sm">
              Capturing moments from across our divisions including real estate projects
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-7 gap-3">
            {[
              ...
              { title: 'Team', desc: 'Dedicated professionals', img: '/images/childcare/4.jpeg' },
              { title: 'Facilities', desc: 'World-class infrastructure', img: '/images/childcare/5.jpeg' },
              { title: 'Real Estate Projects', desc: 'Premium developments', img: '/images/childcare/6.jpeg' },
              { title: 'Construction Sites', desc: 'Quality craftsmanship', img: '/images/childcare/7.jpeg' },
              { title: 'Residential Projects', desc: 'Luxury apartments & villas', img: '/images/childcare/8.jpeg' },
              { title: 'Commercial Spaces', desc: 'Office & retail developments', img: '/images/childcare/9.jpeg' },
              { title: 'Project Management', desc: 'Expert supervision', img: '/images/childcare/10.jpeg' },
              { title: 'Design Innovation', desc: 'Creative architectural solutions', img: '/images/childcare/11.jpeg' },
              { title: 'Quality Control', desc: 'Uncompromising standards', img: '/images/childcare/12.jpeg' },
              { title: 'Community Impact', desc: 'Building better neighborhoods', img: '/images/childcare/13.jpeg' },
              { title: 'Sustainable Construction', desc: 'Green building practices', img: '/images/childcare/14.jpeg' },
            ].map((item, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, scale: 0.95 }}
        ...
        <section id="contact" className="bg-gradient-to-r from-gray-900/80 to-gray-800/60 backdrop-blur rounded-xl p-6 border border-white/10 shadow-lg">
          <div className="md:flex md:items-center md:justify-between gap-4">
            <div className="md:w-1/2">
              <h3 className="text-xl font-bold text-[#f37121]">Get in touch with us</h3>
              <p className="text-gray-300 mt-1 text-sm">Book a visit, partnership inquiry, project consultation, or fleet contract - we reply within 24 hours.</p>
