  ...
  return (
    <main className="bg-[#0a0f1d] text-white min-h-screen antialiased">
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
        ...
        {/* HERO */}
        <section className="text-center space-y-4">
          <h1 className="text-3xl md:text-3xl font-bold text-[#f37121] pt-10">
            Join Our Team
          </h1>
        ...
        <section className="grid md:grid-cols-3 gap-6">
          {jobs.map((job, i) => (
            <div key={job.id} className="bg-white/5 p-4 rounded-lg border border-white/10 shadow hover:shadow-md transition-all space-y-2">
